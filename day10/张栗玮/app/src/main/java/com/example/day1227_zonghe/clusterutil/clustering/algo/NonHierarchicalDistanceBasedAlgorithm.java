...
package com.example.day1227_zonghe.clusterutil.clustering.algo;

import com.baidu.mapapi.model.LatLng;
import com.example.day1227_zonghe.clusterutil.clustering.Cluster;
import com.example.day1227_zonghe.clusterutil.clustering.ClusterItem;
import com.example.day1227_zonghe.clusterutil.projection.Bounds;
import com.example.day1227_zonghe.clusterutil.projection.Point;
import com.example.day1227_zonghe.clusterutil.projection.SphericalMercatorProjection;
import com.example.day1227_zonghe.clusterutil.quadtree.PointQuadTree;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        final Map<QuadItem<T>, com.example.day1227_zonghe.clusterutil.clustering.algo.StaticCluster<T>> itemToCluster =
                new HashMap<QuadItem<T>, com.example.day1227_zonghe.clusterutil.clustering.algo.StaticCluster<T>>();
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                com.example.day1227_zonghe.clusterutil.clustering.algo.StaticCluster<T> cluster =
                        new com.example.day1227_zonghe.clusterutil.clustering.algo
