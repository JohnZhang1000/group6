...
import com.example.leijunqi.mvp.view.fragment.AddFragment;
import com.example.leijunqi.mvp.view.fragment.FoundFragment;
import com.example.leijunqi.mvp.view.fragment.HomeFragment;
import com.example.leijunqi.mvp.view.fragment.MyFragment;
import com.example.leijunqi.mvp.view.fragment.ThesofaFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        tl.getTabAt(1).setText("发现").setIcon(R.drawable.icon_tab_sofa);
        tl.getTabAt(2).setIcon(R.drawable.icon_tab_publish);
        tl.getTabAt(3).setText("商城").setIcon(R.drawable.icon_tab_find);
