...
public class VieoAdapter extends RecyclerView.Adapter<VieoAdapter.ViewHOlder> {
    private Context context;
    private ArrayList<ViewoBean.DataBeanX.DataBean> list;

    public VieoAdapter(Context context, ArrayList<ViewoBean.DataBeanX.DataBean> list) {
