...
public class VideoFragmentAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    private final ArrayList<Shipin.DataBeanX.DataBean> videoBeans;
    private final Context context;

    public VideoFragmentAdapter(ArrayList<Shipin.DataBeanX.DataBean> videoBeans, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder0(LayoutInflater.from(context).inflate(R.layout.sp,parent,false));
    }
