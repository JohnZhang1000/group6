...
import com.example.day07_01.mvp.view.activity.RankingActivity;
...
public class MyRcAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (position == 0) {
            ...
            viewHolder0.thesofa_tl.getTabAt(0).setText("袍子").setIcon(R.drawable.pei5);
            viewHolder0.thesofa_tl.getTabAt(1).setText("社团").setIcon(R.drawable.pei3);
            viewHolder0.thesofa_tl.getTabAt(2).setText("排行榜").setIcon(R.drawable.pei4);
